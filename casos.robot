...
TC01 - Simulação com Matricula Válida: 05-DE-82
    [Tags]      TC01 - Matricula Válida: 05-DE-82
    Inciando o Teste
...
TC02 - Simulação com Matricula Válida: 24-54-XI
    [Tags]      TC02 - Matricula Válida: 24-54-XI
    Inciando o Teste
    Buscando a Matricula
...
TC03 - Simulação com Matricula Válida: 22-HT-53
    [Tags]      TC03 - Matricula Válida: 22-HT-53
    Inciando o Teste
    Buscando a Matricula
...
TC04 - Tentativa de Acesso com a Matricula Inválida: ZZ-AA-00
    [Tags]      TC04 - Matricula Inválida: ZZ-AA-00
    Inciando o Teste
    Buscando a Matricula
